...
"color: white;")
        ...
        self.b_reuselist = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.b_reuselist.setStyleSheet("background-color: orange;")
        self.b_reuselist.setObjectName("b_reuselist")
        self.horizontalLayout_7.addWidget(self.b_reuselist)
    ...
    def retranslateUi(self, ArchivelistFrame):
        ...
        self.b_reuselist.setText(_translate("ArchivelistFrame", "Liste verwenden"))
import menu_rc
