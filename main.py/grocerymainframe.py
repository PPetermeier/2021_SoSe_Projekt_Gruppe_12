...
"color: white;")
    ...
    def retranslateUi(self, Einkaufsplaner):
        ...
        item = self.listofflist.item(0)
        item.setText(_translate("Einkaufsplaner", "Gartenparty"))
        item = self.listofflist.item(1)
        item.setText(_translate("Einkaufsplaner", "Geburtstag Tante Emma"))
